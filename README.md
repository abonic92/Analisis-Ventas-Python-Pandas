...
- `Analisis de datos -ETL.ipynb`: Notebook de Google Colab que contiene todo el código fuente, incluyendo la carga de datos, la limpieza y el análisis.
...
1.  Cloná este repositorio en tu máquina local.
    `git clone https://github.com/abonic92/Analisis-Ventas-Python-Pandas.git`
2.  Abrí el archivo `Analisis de datos -ETL.ipynb` en Google Colab o Jupyter.
